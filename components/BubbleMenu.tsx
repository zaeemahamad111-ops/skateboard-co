...
const DEFAULT_ITEMS: MenuItem[] = [
  { label: 'HOME', href: '#hero', rotation: -8, hoverStyles: { bgColor: 'var(--gold)', textColor: 'var(--charcoal)' } },
  { label: 'SHOP', href: '#products', rotation: 8, hoverStyles: { bgColor: 'var(--charcoal)', textColor: 'var(--cream)' } },
  { label: 'ABOUT', href: '#about', rotation: 8, hoverStyles: { bgColor: 'var(--sand)', textColor: 'var(--charcoal)' } },
  { label: 'GALLERY', href: '#gallery', rotation: -8, hoverStyles: { bgColor: 'var(--gold)', textColor: 'var(--charcoal)' } }
];
            ...
            {items.map((item, idx) => (
              <li key={idx} role="none" className="pill-col">
                <a
                  ...
                  className="pill-link"
                  onClick={() => handleToggle()} // close on click
                  style={{
